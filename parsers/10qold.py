...
def parse_filing(file_path):
    ...
    try:
        ...
        print(f"Unicode error in file {file_path}, attempting to read with utf-16LE encoding.")
    ...
    if table:
        ...
        for idx, row in enumerate(rows):
            ...
            if row_key:
                ...
                row_dict = {headers[i]: row_data[i] for i in range(1, len(headers)) if i < len(row_data)}
